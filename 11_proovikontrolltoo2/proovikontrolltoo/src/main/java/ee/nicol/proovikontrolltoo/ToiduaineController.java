...
@RestController
public abstract class ToiduaineController {
    @Autowired
    ...
    public List<Toiduaine> lisaToiduaine(
        ...
        if(valk + rasv + sysivesik > 100) {
            // Unhandeled exception: java.lang.Exception
...
//* Koosta uus klass, kus on toiduainete listid ning kus saab toiduaineid objektide API otspunktide kaudu lisada ja kustutada, nime järgi andmeid vaadata ning rasvaprotsendivahemiku järgi otsida.

//* Koosta klass toidu jaoks (nimetus, toidukomponendid). Toidule käsklused küsimaks sisalduvate valkude, rasvade ja süsivesikute kogust. Loo retsepti järgi toit (nt. kartulisalat), küsi salatis leiduvate toitainete kogused. Koosta klass, kus näidatakse valitud toidu etteantud koguse (nt. 5 kg kartulisalati) jaoks vajalikud toiduained.